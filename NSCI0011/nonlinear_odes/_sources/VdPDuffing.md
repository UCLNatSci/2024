...
We can see the oscillator shows the following behaviour:
...
5\. Start solving the Duffing equation in Python, can we find any sorts of solutions with stable limit cycles.
